...
namespace TestDb34.Migrations
{
    ...
    [Migration("20240126085140_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestDb34.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TestDb34.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TestDb34.Models.Message", b =>
                {
                    b.HasOne("TestDb34.Models.User", "FromUser")
                        .WithMany("FromMessages")
                        .HasForeignKey("FromUserId")
                        .HasConstraintName("messages_from_user_id_fkey");

                    b.HasOne("TestDb34.Models.User", "ToUser")
                        .WithMany("ToMessages")
